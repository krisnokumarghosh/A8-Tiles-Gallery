  ...
  return (
    <div className="h-screen flex justify-center items-center">
      <div className="bg-white shadow rounded-md md:w-127.75  mx-auto p-10 md:p-15.75">
        <h3 className={`${NotoSerifFont.className} text-[30px]`}>
          Update Profile Information
        </h3>
        <p className="text-[#444748] mt-2  text-[13px] md:text-[16px]">
          Refine your digital presence. Keep your contact details and profile
          imagery current to better showcase your curated collections.
        </p>
