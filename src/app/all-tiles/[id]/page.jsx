    ...
    return (
        <div className='my-27.5 lg:flex gap-20 lg:pl-120'>
           ...
           <div className='text-center lg:text-left'>
            <h1 className={`${NotoSerifFont.className} mt-4 lg:mt-0 text-[28px] md:text-[35px] text-[#1E1E1E]`}>{tile.title}</h1>
            ...
            <p className='text-[13px] text-[#9E9B98] mb-4 font-semibold'>DESCRIPTION</p>
            <p className='w-65  md:w-114 mx-auto lg:mx-0  leading-7 text-[#444748]'>{tile.description}</p>
            <p className='text-[13px] mt-10 text-[#9E9B98] mb-4 font-semibold'>SPECIFICATIONS</p>
           ...
           <button className='btn border-0 mt-5 rounded-full bg-[#536257] lg:w-full text-white'>Request A Sample</button>
           </div>
        </div>
    );
};
